...
static gboolean video_tags_changed_nofity (PlayerControlBase *player)                                
{                                                                               
  PlayerControlBasePrivate *priv = GET_PRIVATE (player);                                
  //UMMS_DEBUG ("Begin");
...
static gboolean audio_tags_changed_nofity (PlayerControlBase *player)                 
{                                                                               
  PlayerControlBasePrivate *priv = GET_PRIVATE (player);                                
  //UMMS_DEBUG ("Begin");
...
{
  PlayerControlBase * player = (PlayerControlBase *) user_data;
  PlayerControlBasePrivate *priv = GET_PRIVATE (player);
